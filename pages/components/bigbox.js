...
const BigBox = (props) => {
  ...
  return (
    <div className={`w-full lg:h-[100vh] md:h-[100vh] h-[70vh] relative lg:p-14 md:p-10 p-8 text-white flex items-start justify-end flex-col lg:gap-5 md:gap-5 gap-2 bg-gradient-to-t from-[#000000aa] to-[transparent] w-${width}`}>
