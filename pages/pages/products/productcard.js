...
const ProductCard = ({ description, id, name, price, image, isFavourite, inBag }) => {
    ...
    return (
        <>
            <Link href={`/pages/products/${id}`} className='w-fit h-fit'>
                <div className="product group  lg:w-[20vw] md:w-full w-full  h-fit min-h-[300px] bg-[#e3e3e333] flex-shrink-0 relative overflow-hidden hover:border-[0.1px] border-[#00000020]">
